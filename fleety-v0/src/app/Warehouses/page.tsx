          ...
          <table className="min-w-full">
            ...
            <tbody>
              {warehouses.map((warehouse) => (
                <tr key={warehouse.id}>
                  <td className="border border-gray-300 px-4 py-2 text-center">{warehouse.id}</td>
                  <td className="border border-gray-300 px-4 py-2 text-center">{warehouse.location}</td>
                  <td className="border border-gray-300 px-4 py-2 text-center">{warehouse.capacity}</td>
                  <td className="border border-gray-300 px-4 py-2 text-center">{warehouse.currentStock}</td>
                  <td className="border border-gray-300 px-4 py-2 text-center">{warehouse.manager}</td>
                </tr>
              ))}
            </tbody>
          </table>
